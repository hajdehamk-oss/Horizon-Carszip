...
export default function HaendlerDetail() {
  ...
  const dealerQuery = useGetDealer(dealerId);
  const vehiclesQuery = useGetDealerVehicles(dealerId);
  const dealer = dealerId ? dealerQuery.data : undefined;
  const isLoadingDealer = dealerId ? dealerQuery.isLoading : false;
  const vehicles = dealerId ? vehiclesQuery.data : undefined;
  const isLoadingVehicles = dealerId ? vehiclesQuery.isLoading : false;
